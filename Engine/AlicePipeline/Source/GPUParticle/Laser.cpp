...
void CreateLaserDrawMaterial(MaterialManager* manager_,IAdapter* adapter_)
{
	...
	//頂点シェーダの読み込み
	lMaterial->vertexShader = CreateUniqueShader("Resources/Shaders/AliceParticle/Laser/VS.hlsl");

	//ジオメトリシェーダの読み込み
	lMaterial->geometryShader = CreateUniqueShader("Resources/Shaders/AliceParticle/Laser/GS.hlsl","main","gs_5_0",IShader::ShaderType::GS);

	//ピクセルシェーダの読み込み
	lMaterial->pixelShader = CreateUniqueShader("Resources/Shaders/AliceParticle/Laser/PS.hlsl","main","ps_5_0",IShader::ShaderType::PS);
	...
	lMaterial->rootSignature->Add(IRootSignature::RangeType::SRV,1);//t0

	lMaterial->rootSignature->AddStaticSampler(0);//s0
	lMaterial->rootSignature->AddStaticSampler(1);//s0
	...
	manager_->AddMaterial(lMaterial,"LaserGPUParticleDraw");
}
...
void CreateLaserEmitComputeMaterial(MaterialManager* manager_,IAdapter* adapter_)
{
	...
	//頂点シェーダの読み込み
	lMaterial->computeShader = CreateUniqueShader("Resources/Shaders/AliceParticle/Laser/EmitCS.hlsl","main","cs_5_0",IShader::ShaderType::CS);
	...
	manager_->AddMaterial(lMaterial,"ComputeLaserGPUParticleEmit");
}
...
void CreateLaserUpdateComputeMaterial(MaterialManager* manager_,IAdapter* adapter_)
{
	...
	//頂点シェーダの読み込み
	lMaterial->computeShader = CreateUniqueShader("Resources/Shaders/AliceParticle/Laser/UpdateCS.hlsl","main","cs_5_0",IShader::ShaderType::CS);
	...
	manager_->AddMaterial(lMaterial,"ComputeLaserGPUParticleUpdate");
}
...
void CreateLaserDrawArgumentUpdateComputeMaterial(MaterialManager* manager_,IAdapter* adapter_)
{
	...
	//シェーダの読み込み
	lMaterial->computeShader = CreateUniqueShader("Resources/Shaders/AliceParticle/Laser/DrawArgumentUpdateCS.hlsl","main","cs_5_0",IShader::ShaderType::CS);
	...
	manager_->AddMaterial(lMaterial,"ComputeLaserGPUParticleDrawArgumentUpdate");
}
...
void CreateLaserFreeListInitComputeMaterial(MaterialManager* manager_,IAdapter* adapter_)
{
	...
	//シェーダの読み込み
	lMaterial->computeShader = CreateUniqueShader("Resources/Shaders/AliceParticle/Laser/FreeListInitializeCS.hlsl","main","cs_5_0",IShader::ShaderType::CS);
	...
	manager_->AddMaterial(lMaterial,"ComputeLaserGPUParticleFreeListInit");
}
