...
void CreateScatteringComputeMaterial(MaterialManager* manager_,IAdapter* adapter_)
{
	...
	//シェーダの読み込み
	lMaterial->computeShader = CreateUniqueShader("Resources/Shaders/AliceParticle/Scattering/ScatteringCS.hlsl","main","cs_5_0",IShader::ShaderType::CS);
	...
	manager_->AddMaterial(lMaterial,"ComputeScattering");
}
