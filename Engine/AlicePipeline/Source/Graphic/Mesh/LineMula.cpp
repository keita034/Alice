...
void CreateLineMulaMaterial(MaterialManager* manager_,IAdapter* adapter_)
{
	...
	lMaterial->blenddesc = CreateBlend(BlendMode::AX_BLENDMODE_MULA);
	...
	manager_->AddMaterial(lMaterial,"MashLineMula");
}
