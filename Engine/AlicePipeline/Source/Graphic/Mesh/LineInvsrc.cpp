...
void CreateLineInvsrcMaterial(MaterialManager* manager_,IAdapter* adapter_)
{
	...
	lMaterial->blenddesc = CreateBlend(BlendMode::AX_BLENDMODE_INVSRC);
	...
	manager_->AddMaterial(lMaterial,"MashLineInvsrc");
}
