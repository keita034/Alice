...
void CreateLineNoblendMaterial(MaterialManager* manager_,IAdapter* adapter_)
{
	...
	lMaterial->primitiveType = D3D12_PRIMITIVE_TOPOLOGY_TYPE_LINE;

	lMaterial->blenddesc = CreateBlend(BlendMode::AX_BLENDMODE_NOBLEND);
	...
	manager_->AddMaterial(lMaterial,"MashLineNoblend");
}
