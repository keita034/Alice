...
public:
	...
	void SetConstBufferView(ICommandList* cmdList_,uint32_t rootParameterIndex_)const;

	static void SSetDevice(IDevice* device_);
	static AliceMathF::Vector3* SGetLightDirPtr();
	static AliceMathF::Vector4* SGetLightColorPtr();
