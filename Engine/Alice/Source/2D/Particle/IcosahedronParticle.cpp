...
void IcosahedronParticle::Add(UINT life, const AliceMathF::Vector3& position, const AliceMathF::Vector3& velocity,
...
void IcosahedronParticle::Draw(Camera* camera, Material* material)
{
	...
	if (!material)
	{
		particleMaterial = MaterialManager::GetMaterial("IcosahedronParticle");
	}
	...
	// SRVヒープの設定コマンド
	ID3D12DescriptorHeap* descriptorHeaps[] = { textureData->srvHeap };
