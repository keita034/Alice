...
void RenderTarget::Initialize(uint32_t width_, uint32_t height_, D3D12_RESOURCE_STATES resourceStates_, const std::array<float,4>& clear_, DXGI_FORMAT rtFormat_, DXGI_FORMAT dsFormat_)
{
	//クリアカラー
	
	clearColor = {{ clear_[0],clear_[ 1 ],clear_[ 2 ],clear_[ 3 ]}};
