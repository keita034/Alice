...
void OBBCollider::CreateOBB(const std::vector<PosNormUvTangeColSkin>& vertexs_, const  AliceMathF::Vector3& translation_, const AliceMathF::Vector3& rotation_, const AliceMathF::Vector3& scale_)
{
	//最大値、最小値の初期値設定
	AliceMathF::Vector3 lMax = AliceMathF::Vector3(-10000.0f, -10000.0f, -10000.0f);
	AliceMathF::Vector3 lMin = AliceMathF::Vector3(10000.0f, 10000.0f, 10000.0f);
	...
	//最大値、最小値取得ループ
	for (const PosNormUvTangeColSkin& vertex : vertexs_)
	{
		const AliceMathF::Vector4& lPos = vertex.position;
