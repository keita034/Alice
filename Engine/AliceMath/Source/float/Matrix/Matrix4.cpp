...
namespace AliceMathF
{
	...
	Matrix4::Matrix4(const JPH::DMat44& mat_)
	{
	...
	Matrix4::Matrix4(const physx::PxMat44& mat_)
	{
		...
		m[ 0 ][ 1 ] = mat_.column0.y;
		m[ 0 ][ 2 ] = mat_.column0.z;
		m[ 0 ][ 3 ] = mat_.column0.w;

		m[ 1 ][ 0 ] = mat_.column1.x;
		m[ 1 ][ 1 ] = mat_.column1.y;
		m[ 1 ][ 2 ] = mat_.column1.z;
		m[ 1 ][ 3 ] = mat_.column1.w;

		m[ 2 ][ 0 ] = mat_.column2.x;
		m[ 2 ][ 1 ] = mat_.column2.y;
		m[ 2 ][ 2 ] = mat_.column2.z;
		m[ 2 ][ 3 ] = mat_.column2.w;

		m[ 3 ][ 0 ] = mat_.column3.x;
		m[ 3 ][ 1 ] = mat_.column3.y;
		m[ 3 ][ 2 ] = mat_.column3.z;
		m[ 3 ][ 3 ] = mat_.column3.w;
	}
	...
	Matrix4::operator JPH::DMat44() const
	{
		JPH::DMat44 lMat{};
