...
void BloomPostEffect::Initialize()
{
	if (needsInit)
	{
		...
		//頂点シェーダの読み込み
		material->vertexShader = CreateUniqueShader("Resources/Shaders/AlicePostEffect/Bloom/BloomVS.hlsl");

		//ピクセルシェーダの読み込み
		material->pixelShader = CreateUniqueShader("Resources/Shaders/AlicePostEffect/Bloom/BloomPS.hlsl", "main", "ps_5_0");
		...
		//頂点シェーダの読み込み
		material2->vertexShader = CreateUniqueShader("Resources/Shaders/AlicePostEffect/Bloom/BloomDrawVS.hlsl");

		//ピクセルシェーダの読み込み
		material2->pixelShader = CreateUniqueShader("Resources/Shaders/AlicePostEffect/Bloom/BloomDrawPS.hlsl", "main", "ps_5_0");
