...
void StripedPostEffect::Initialize()
{
	if (needsInit)
	{
		...
		//頂点シェーダの読み込み
		material->vertexShader = CreateUniqueShader("Resources/Shaders/AlicePostEffect/Striped/StripedVS.hlsl");

		//ピクセルシェーダの読み込み
		material->pixelShader = CreateUniqueShader("Resources/Shaders/AlicePostEffect/Striped/StripedPS.hlsl", "main", "ps_5_0");
		...
		//頂点シェーダの読み込み
		material2->vertexShader = CreateUniqueShader("Resources/Shaders/AlicePostEffect/Striped/StripedDrawVS.hlsl");

		//ピクセルシェーダの読み込み
		material2->pixelShader = CreateUniqueShader("Resources/Shaders/AlicePostEffect/Striped/StripedDrawPS.hlsl", "main", "ps_5_0");
