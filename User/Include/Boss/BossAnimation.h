...
private:
	...
	uint32_t downRightAttackAnimationHandle;
	uint32_t downLeftAttackAnimationHandle;
	...
	uint32_t blowawayAnimationHandle;
...
public:
	...
	void InsertDownRightAttackAnimation();
	void InsertDownLeftAttackAnimation();
